...
class ListaAtomica {
 ...
 public:
    ...
    void insertar(const T &valor) {
        ...
        //si cabeza no es igual a nuevo->_siguiente, se actualiza cabeza con nuevo->siguiente
        //si cabeza es igual a nuevo->siguiente, expected toma el valor viejo de cabeza y cabeza toma el valor de nuevo
